...
class _SportNewsState extends State<SportNews> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body:
        BlocBuilder<SportNewsCubit, SportNewsState>(builder: (context, state) {
      ...
      } else if (state is SportNewsLoaded) {
        sportNewsData = BlocProvider.of<SportNewsCubit>(context).sportNewsModel;
        return topSportNewsLoaded();
        ...
        children: [
          Expanded(
            child: PageView.builder(
                              ...
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(
                                      ...
                                      Adaptive.w(1)),
                                  child: Text(
                                    sportNewsData!.articles![index].source!
                                                .name ==
                                            null
                                        ? 'Unknown Auther'
                                        : sportNewsData!
                                ...
                                Container(
                                  margin: EdgeInsets.only(
                                      ...
                                      bottom: Adaptive.w(2)),
                                  child: Text(
                                    sportNewsData!.articles![index].title
                                        .toString(),
              ...
              itemCount: sportNewsData!.articles!.length,
              controller:
