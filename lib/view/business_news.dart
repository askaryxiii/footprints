...
class _BusinessNewsState extends State<BusinessNews> {
  News? businessNewsData;
  int currentPage = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: BlocBuilder<BusinessNewsCubit, BusinessNewsState>(
      ...
      if (state is BusinessNewsLoading) {
        ...
        businessNewsData =
            BlocProvider.of<BusinessNewsCubit>(context).businessNewsModel;
        return businessNewsLoaded();
                              ...
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(
                                      ...
                                      Adaptive.w(1)),
                                  child: Text(
                                    businessNewsData!.articles![index].source!
                                                .name ==
                                            null
                                        ? 'Unknown Auther'
                                        : businessNewsData!
                                ...
                                Container(
                                  margin: EdgeInsets.only(
                                      ...
                                      bottom: Adaptive.w(2)),
                                  child: Text(
                                    businessNewsData!.articles![index].title
                                        .toString(),
